...
CREATE OR REPLACE PUBLIC SYNONYM REF_CHANGE_AGENT FOR DBA.REF_CHANGE_AGENT;
CREATE OR REPLACE PUBLIC SYNONYM REF_LEGEND FOR DBA.REF_LEGEND;
CREATE OR REPLACE PUBLIC SYNONYM IS_ROLE_GRANTED FOR DBA.IS_ROLE_GRANTED;
