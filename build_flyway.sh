...
cat << 'EOF' >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
...
/
EOF
# Deploy DENY_ACTION first as it is a core dependency for many objects
expand_sql "$BASE_DIR/PROCEDURES/deny_action.prc" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/TYPES/type.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/SEQUENCES/sequence.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/PACKAGES/package.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_legacy_datatype_insert | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/FUNCTIONS/function.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_legacy_datatype_insert | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/PROCEDURES/procedure.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_legacy_datatype_insert | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/PROCEDURES/czar_procedure.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_legacy_datatype_insert | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/VIEWS/view.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_legacy_datatype_insert | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/CONSTRAINTS/constraint.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | fix_legacy_datatype_insert | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/CONSTRAINTS/czar_constraints.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/TRIGGERS/trigger.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/TRIGGERS/czar_trigger.script" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/view.ddl" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/trigger.ddl" | placeholder_replace | remove_version_table_creation | wrap_safe_sql | convert_synonym_idempotent | fix_acl_idempotency | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_6__Logic_and_Constraints.sql"

# V1_0_7: Permissions and Synonyms
echo "ALTER SESSION SET CURRENT_SCHEMA = \${hdb_user};" > "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/syn.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | remove_version_table_creation | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/czar_syn.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | remove_version_table_creation | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/userpriv.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | remove_version_table_creation | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/czar_userpriv.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | remove_version_table_creation | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/rolepriv.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | remove_version_table_creation | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/czar_rolepriv.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | remove_version_table_creation | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_7__Permissions_and_Synonyms.sql"

# V1_0_8: Post-Migration Cleanup, Comments, and Recompilation
echo "ALTER SESSION SET CURRENT_SCHEMA = \${hdb_user};" > "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
echo "-- Incorporating comments.sql" >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/comments.sql" | placeholder_replace | wrap_safe_comments | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
echo "-- Incorporating update_global_names.sql" >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/update_global_names.sql" | placeholder_replace | wrap_safe_sql | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
echo "-- Incorporating additional_db_mods.sql" >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
expand_sql "$BASE_DIR/SCHEMA/BASE_SCRIPTS/additional_db_mods.sql" | placeholder_replace | wrap_safe_sql | fix_sqlplus_execute | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
cat << 'EOF' >> "$OUT_DIR/V1_0_8__Post_Migration_Cleanup.sql"
...
# V1_0_9: HDB Permissions
echo "ALTER USER psswd_user QUOTA UNLIMITED ON HDB_idx;" > "$OUT_DIR/V1_0_9__HDB_Permissions.sql"
echo "ALTER SESSION SET CURRENT_SCHEMA = psswd_user;" >> "$OUT_DIR/V1_0_9__HDB_Permissions.sql"
expand_sql "$BASE_DIR/PERMISSIONS/create_role_psswd.sql" | placeholder_replace | wrap_safe_sql | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_9__HDB_Permissions.sql"
expand_sql "$BASE_DIR/PERMISSIONS/check_valid_role_name.prc" | placeholder_replace | wrap_safe_sql | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_9__HDB_Permissions.sql"
expand_sql "$BASE_DIR/PERMISSIONS/role_psswd_fk.trg" | placeholder_replace | wrap_safe_sql | fix_hdb_references | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_9__HDB_Permissions.sql"
echo "BEGIN EXECUTE IMMEDIATE 'GRANT SELECT ON psswd_user.role_psswd TO PUBLIC'; EXCEPTION WHEN OTHERS THEN NULL; END;" >> "$OUT_DIR/V1_0_9__HDB_Permissions.sql"
...
echo "ALTER SESSION SET CURRENT_SCHEMA = \${hdb_user};" > "$OUT_DIR/V1_0_10__HDB_Metadata.sql"
expand_sql "$BASE_DIR/METADATA/V_DBA_ROLES.sql" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | convert_view_idempotent | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_10__HDB_Metadata.sql"
expand_sql "$BASE_DIR/METADATA/V_DT_UT.sql" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | convert_view_idempotent | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_10__HDB_Metadata.sql"
expand_sql "$BASE_DIR/METADATA/V_SITEDT.sql" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | convert_view_idempotent | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_10__HDB_Metadata.sql"
expand_sql "$BASE_DIR/METADATA/cg_ref_codes.ddl" | placeholder_replace | wrap_safe_sql | convert_synonym_idempotent | convert_view_idempotent | fix_sqlplus_terminators >> "$OUT_DIR/V1_0_10__HDB_Metadata.sql"
cat << 'EOF' >> "$OUT_DIR/V1_0_10__HDB_Metadata.sql"
...
# V1_0_11: Check Invalids
cat << 'EOF' > "$OUT_DIR/V1_0_11__Check_Invalids.sql"
...
# V1_0_12: Check Errors
cat << 'EOF' > "$OUT_DIR/V1_0_12__Check_Errors.sql"
